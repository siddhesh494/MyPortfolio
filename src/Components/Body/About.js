  ...
  return (
    <div className=" my-28 ">
      <div className="flex flex-col text-center">
        ...
        <span className="text-4xl dark:text-white">{lang[language]?.aboutMe?.aboutMe}</span>
      </div>
        ...
        <div className="flex justify-center flex-col items-center mx-10">
          <div className="flex flex-col gap-10 sm:flex-row ">
            <div className="border border-black dark:border-blue-700 py-5 px-20 rounded-3xl flex items-center text-center flex-col hover:shadow-xl dark:hover:shadow-blue-700 dark:hover:shadow-lg">
              ...
              <span className="font-bold dark:text-white">{lang[language]?.aboutMe?.experience}</span>
              <span className=' dark:text-white'>{lang[language]?.aboutMe?.year}</span>
              <span className=' dark:text-white'>{lang[language]?.aboutMe?.fsd}</span>
            </div>

            <div className="border border-black dark:border-blue-700 py-5 px-20 rounded-3xl flex items-center text-center flex-col hover:shadow-xl dark:hover:shadow-blue-700 dark:hover:shadow-lg">
              <img src={Education} className='w-7 dark:invert dark:brightness-0' alt="img" />
              <span className="font-bold dark:text-white">{lang[language]?.aboutMe?.education}</span>
              <span className=' dark:text-white'>{lang[language]?.aboutMe?.eng}</span>
              <span className=' dark:text-white'>{lang[language]?.aboutMe?.hsc}</span>
            </div>
